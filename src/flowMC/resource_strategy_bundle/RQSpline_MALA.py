...
class RQSpline_MALA_Bundle(ResourceStrategyBundle):
    ...
    def __init__(
        ...
        """Build all resources and strategies for an RQSpline + MALA sampling run.
        ...
        Args:
            ...
            n_local_steps (int): MALA steps per training/production loop iteration.
            ...
            mala_step_size (float | Float[Array, "n_dim"]): Initial MALA step size;
