...
**Ensure the bug was not already reported** by searching on GitHub under [Issues](https://github.com/GW-JAX-Team/flowMC/issues).
If you’re unable to find an open issue addressing the problem, [open a new one](https://github.com/GW-JAX-Team/flowMC/issues/new).
...
For more extensive tutorials, we encourage the community to link minimal examples hosted on the flowMC documentation to documentation from other packages.
